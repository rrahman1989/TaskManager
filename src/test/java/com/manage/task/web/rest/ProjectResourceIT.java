...
import com.manage.task.domain.Project;
import com.manage.task.repository.ProjectRepository;
...
class ProjectResourceIT {
    ...
    public static Project createEntity(EntityManager em) {
        Project project = new Project().code(DEFAULT_CODE).name(DEFAULT_NAME);
        return project;
    }
    ...
    public static Project createUpdatedEntity(EntityManager em) {
        Project project = new Project().code(UPDATED_CODE).name(UPDATED_NAME);
        return project;
    }
    ...
    void putNewProject() throws Exception {
        ...
        updatedProject.code(UPDATED_CODE).name(UPDATED_NAME);
