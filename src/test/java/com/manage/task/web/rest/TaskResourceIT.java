...
class TaskResourceIT {
    ...
    void putNewTask() throws Exception {
        ...
        updatedTask.taskName(UPDATED_TASK_NAME).startDate(UPDATED_START_DATE).endDate(UPDATED_END_DATE).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.startDate(UPDATED_START_DATE).description(UPDATED_DESCRIPTION);
