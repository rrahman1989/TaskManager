...
class StatusResourceIT {
    ...
    public static Status createEntity(EntityManager em) {
        Status status = new Status().code(DEFAULT_CODE).name(DEFAULT_NAME);
        return status;
    }
    ...
    public static Status createUpdatedEntity(EntityManager em) {
        Status status = new Status().code(UPDATED_CODE).name(UPDATED_NAME);
        return status;
    }
    ...
    void putNewStatus() throws Exception {
        ...
        updatedStatus.code(UPDATED_CODE).name(UPDATED_NAME);
    ...
    void fullUpdateStatusWithPatch() throws Exception {
        ...
        partialUpdatedStatus.code(UPDATED_CODE).name(UPDATED_NAME);
