...
describe('Project e2e test', () => {
  ...
  const projectSample = { code: 'French transmit', name: 'Checking' };
  ...
  describe('new Project page', () => {
    ...
    it('should create an instance of Project', () => {
      cy.get(`[data-cy="code"]`).type('feed').should('have.value', 'feed');

      cy.get(`[data-cy="name"]`).type('Fantastic brand sticky').should('have.value', 'Fantastic brand sticky');
