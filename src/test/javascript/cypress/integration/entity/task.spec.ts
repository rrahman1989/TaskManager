...
describe('Task e2e test', () => {
  ...
  const taskSample = { taskName: 'COM', startDate: '2022-04-09T23:33:59.250Z', endDate: '2022-04-09T08:05:34.782Z' };
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      ...
      cy.get(`[data-cy="startDate"]`).type('2022-04-09T09:08').should('have.value', '2022-04-09T09:08');

      cy.get(`[data-cy="endDate"]`).type('2022-04-09T17:33').should('have.value', '2022-04-09T17:33');
