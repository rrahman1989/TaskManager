...
import com.manage.task.repository.StatusRepository;
...
/**
 * REST controller for managing {@link com.manage.task.domain.Status}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Status> result = statusRepository
            ...
            .map(existingStatus -> {
                if (status.getCode() != null) {
                    existingStatus.setCode(status.getCode());
                }
